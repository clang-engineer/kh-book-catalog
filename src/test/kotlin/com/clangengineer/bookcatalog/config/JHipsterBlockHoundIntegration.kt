...
class JHipsterBlockHoundIntegration : BlockHoundIntegration {
    override fun applyTo(builder: BlockHound.Builder) {
        ...
        builder.allowBlockingCallsInside("com.clangengineer.bookcatalog.service.MailService", "sendEmailFromTemplate")
        builder.allowBlockingCallsInside("com.clangengineer.bookcatalog.security.DomainUserDetailsService", "createSpringSecurityUser")
    }
}
