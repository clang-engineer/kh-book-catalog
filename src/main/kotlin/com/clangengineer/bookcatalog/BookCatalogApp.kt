package com.clangengineer.bookcatalog

import com.clangengineer.bookcatalog.config.ApplicationProperties
import com.clangengineer.bookcatalog.config.CRLFLogConverter
...
class BookCatalogApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<BookCatalogApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(BookCatalogApp::class.java)
