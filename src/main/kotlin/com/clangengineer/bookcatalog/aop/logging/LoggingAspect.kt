package com.clangengineer.bookcatalog.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.clangengineer.bookcatalog.repository..*)" +
            " || within(com.clangengineer.bookcatalog.service..*)" +
            " || within(com.clangengineer.bookcatalog.web.rest..*)"
    )
